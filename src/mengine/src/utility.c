...
float *vector( int nl, int nh)
{
                ...
                if (!v)
        {
             ...
             fprintf(pcmlogfile,"error allocating float vector\n");
             exit(0);
        }
        return v-nl;
}
 ...
 int *ivector( int nl, int nh)
{
        ...
        if (!v)
        {
             ...
             fprintf(pcmlogfile,"error allocating  int vector\n");
             exit(0);
        }
        return v-nl;
}
...
double *dvector( int nl, int nh)
{
        ...
        if (!v)
        {
            ...
            fprintf(pcmlogfile,"error allocating double vector\n");
            exit(0);
        }
        return v-nl;
}
...
float **matrix( int nrl,  int nrh,  int ncl,  int nch)
{
        ...
        if (!m)
        {
             ...
             fprintf(pcmlogfile,"error allocating float array\n");
             exit(0);
        }
        m -= nrl;
...
double **dmatrix( int nrl,  int nrh,  int ncl,  int nch)
{
        ...
        if (!m)
        {
             ...
             fprintf(pcmlogfile,"error allocating double array\n");
             exit(0);
        }
        m -= nrl;
 ...
 int **imatrix( int nrl,  int nrh,  int ncl,  int nch)
{
        ...
        if (!m)
        {
             ...
             fprintf(pcmlogfile,"error allocating array\n");
             exit(0);
        }
        m -= nrl;
